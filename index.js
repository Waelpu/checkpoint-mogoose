...
(async () => {
  try {
    const result = await person.create([
      { name: "Eno", age: 40, favoriteFoods: ["Frogs", "Fish"] },
      { name: "Samuel", age: 13, favoriteFoods: ["Eel", "Duck"] },
      { name: "Enyinna", age: 30, favoriteFoods: ["Danishes", "Ravioli"] },
    ]);
